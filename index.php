...
?>
<div class="p-7 m-7 rounded-lg bg-gray-500">
  <div class="mb-5"><p class="text-lg font-medium text-xs leading-tight uppercase text-white mb-7">PELAJAR ILPKLS</p></div>
    <a class="p-3 font-medium text-xs leading-tight uppercase bg-green-500 text-white rounded-lg" href="tambahpelajar.php">TAMBAH</a>
</div>
    ...
    <div class="relative w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                <button type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"><a href="padampelajar.php?delete_id=<?php echo $info["id"]; ?>">YES DELETE!</a></button>
