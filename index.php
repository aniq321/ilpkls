...
<div class="p-7 m-7 rounded-lg bg-gray-500">
  <div class="mb-5"><p class="text-lg font-medium text-xs leading-tight uppercase text-white mb-7">PEKERJA MEGAHOLDING</p></div>
    <a class="p-3 font-medium text-xs leading-tight uppercase bg-green-500 text-white rounded-lg" href="tambahpekerja.php">TAMBAH</a>
</div>
